(() => {
  ...
  const USE_PROXY = location.hostname === 'localhost' || location.hostname.startsWith('127.');

  // ======== UTIL UI (TIDAK GLOBAL) ========
  ...
  console.log('[proxy] raw:', txt.slice(0, 300)); // lihat 300 char pertama

  // kalau bukan 2xx, langsung lempar error biar kebaca di UI
  ...
  // JSONP (callback tetap + queue) — aman untuk live-reload di production
  ...
  // ======== EXPOSE HANYA LEWAT window.Auth ========
